...
class PortfolioItemsControllerTest < ActionController::TestCase
  ...
  test "should create portfolio_item" do
    assert_difference('PortfolioItem.count') do
      post :create, portfolio_item: { description: @portfolio_item.description, img: @portfolio_item.img, link: @portfolio_item.link, name: @portfolio_item.name }
    end
  ...
  test "should update portfolio_item" do
    patch :update, id: @portfolio_item, portfolio_item: { description: @portfolio_item.description, img: @portfolio_item.img, link: @portfolio_item.link, name: @portfolio_item.name }
    assert_redirected_to portfolio_item_path(assigns(:portfolio_item))
  end
